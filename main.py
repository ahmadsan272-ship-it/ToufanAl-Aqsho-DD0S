...
def countdown(t):
    ...
    while True:
        ...
        if remaining_time > 0:
            ...
            print(f"\r{Fore.YELLOW} [*] \033[104m \033[37mT0UFAN AL-AQSHA \033[0m {Fore.WHITE}=>  {Fore.RED}Attack status {Fore.MAGENTA} => {Fore.YELLOW} {remaining_time:.2f} {Fore.LIGHTBLUE_EX}sec left ")
            print(f"\r{Fore.WHITE} [*] {Fore.GREEN} T0UFAN AL-AQSHA {Fore.RED} =>  {Fore.WHITE}Status attack {Fore.GREEN} => {Fore.CYAN} {remaining_time:.2f} {Fore.WHITE}sec left ")
        else:
            stdout.flush()
